...
aa.pack()
gl_button_easy = Button(gl_window, text="Легкая", command=lambda: change_difficulty("Легкий"), bg="#585858", fg="green", font=("Arial", 32))
gl_button_easy.pack()
bb = Label(gl_window, text="", bg="#000", fg="white", font=("Arial", 32))
bb.pack()
gl_button_medium = Button(gl_window, text="Средняя", command=lambda: change_difficulty("Средний"), bg="#585858", fg="orange", font=("Arial", 32))
gl_button_medium.pack()
cc = Label(gl_window, text="", bg="#000", fg="white", font=("Arial", 32))
cc.pack()
gl_button_hard = Button(gl_window, text="Тяжелая", command=lambda: change_difficulty("Тяжелый"), bg="#585858", fg="red", font=("Arial", 32))
gl_button_hard.pack()
