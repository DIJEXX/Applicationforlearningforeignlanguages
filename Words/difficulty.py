...
gl_difficulty_label = Label(gl_window, text="Выберите сложность:", font=("Roboto", 32))
gl_difficulty_label.pack(pady=100)
gl_button_easy = Button(gl_window, text="Легкая", command=lambda: change_difficulty("Легкая"), fg="green", font=("Roboto", 32))
gl_button_easy.pack(pady=10)
gl_button_medium = Button(gl_window, text="Средняя", command=lambda: change_difficulty("Средняя"), fg="orange", font=("Roboto", 32))
gl_button_medium.pack(pady=10)
gl_button_hard = Button(gl_window, text="Тяжелая", command=lambda: change_difficulty("Тяжелая"), fg="red", font=("Roboto", 32))
gl_button_hard.pack(pady=10)
selected_difficulty_label_text = "Выбранная сложность: "
selected_difficulty_label = Label(gl_window, text=selected_difficulty_label_text, font=("Roboto", 32))
selected_difficulty_label.pack(pady=10)
selected_difficulty_label_value = Label(gl_window, textvariable=selected_difficulty, font=("Roboto", 32))
