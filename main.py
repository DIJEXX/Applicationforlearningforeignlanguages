...
def open_main_window():
    ...
    welcome_label = Label(main_window, text="Welcome!\n", bg="#000", fg="white", font=("Arial", 32))
    welcome_label.pack()
    ...
    gg.pack()
    words_button = Button(main_window, text="Words", command=open_words_window, bg="#585858", fg="white", font=("Arial", 32))
    words_button.pack()
    bb = Label(main_window, text="", bg="#000", fg="white", font=("Arial", 32))
    bb.pack()
    text_button = Button(main_window, text="Text", command=open_text_window, bg="#585858", fg="white", font=("Arial", 32))
    text_button.pack()
    dd = Label(main_window, text="", bg="#000", fg="white", font=("Arial", 32))
    dd.pack()
    sound_button = Button(main_window, text="Listening", command=open_sound_window, bg="#585858", fg="white", font=("Arial", 32))
    sound_button.pack()
