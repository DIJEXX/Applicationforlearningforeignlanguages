...
register_label = Label(first_window, text="Register", font=("Roboto", 28))
...
register_button = Button(first_window, text="Sign up", command=register_user, font=("Roboto", 28))
...
login_button = Button(first_window, text="Entry", command=login_user, font=("Roboto", 28))
